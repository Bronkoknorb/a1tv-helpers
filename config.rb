...
A1TV_SOURCE_M3U_FILE_URL = "http://epggw.a1.net/a/service.m3u"
...
#A1TV_SOURCE_M3U_FILE_URL = "m3u/A1-TV_all.m3u"
...
CHANNEL_TABLE = {
  ...
  "kabel eins Doku Austria" => "doku.kabel1.de",
  "RTL Austria" => "rtl.de",
  ...
  "RTL II Austria" => "rtl2.de",
  "RTL II Oesterreich" => "rtl2.de",
  "ATV//" => "atv2.at",
  "ATV2" => "atv2.at",
  "ATV 2" => "atv2.at",
  "Sat.1 Gold" => "gold.sat1.de",
  "Sat.1 Gold Austria" => "gold.sat1.de",
  ...
  "ORF SPORT+" => "sportplus.orf.at",
  "ORF Sport+" => "sportplus.orf.at",
  "ORF Sport+ HD" => "sportplus.orf.at",
  "SuperRTL" => "super.rtl.de",
  "Super RTL Austria" => "super.rtl.de",
  ...
  "ZDF Info" => "infokanal.zdf.de",
  "ZDF Info HD" => "infokanal.zdf.de",
  ...
  "Tagesschau 24 HD" => "einsextra.daserste.de",
  "einsfestival" => "einsfestival.daserste.de",
  "EinsFestival" => "einsfestival.daserste.de",
  "Eins Festival HD" => "einsfestival.daserste.de",
  "One" => "einsfestival.daserste.de",
  "One HD" => "einsfestival.daserste.de",
  "ARD alpha" => "br-alpha.daserste.de",
  "ARD Alpha" => "br-alpha.daserste.de",
  "Tele 5" => "tele5.de",
  "SWR BW" => "bw.swr.daserste.de",
  "SWR BW HD" => "bw.swr.daserste.de",
  "mdr" => "mdr.daserste.de",
  "MDR" => "mdr.daserste.de",
  "MDR HD" => "mdr.daserste.de",
  "MDR Sachsen Anhalt" => "mdr.daserste.de",
  "MDR Sachsen Anhalt HD" => "mdr.daserste.de",
  "NDR" => "ndr.daserste.de",
  "NDR HH" => "ndr.daserste.de",
  "NDR HH HD" => "ndr.daserste.de",
  "WDR" => "wdr.daserste.de",
  "WDR Koeln" => "wdr.daserste.de",
  "WDR Koeln HD" => "wdr.daserste.de",
  "hr" => "hr.daserste.de",
  "hr HD" => "hr.daserste.de",
  "rbb" => "rbb.daserste.de",
  "rbb Berlin" => "rbb.daserste.de",
  "SR" => "sr.swr.daserste.de",
  "SWR" => "sr.swr.daserste.de",
  "BBC World News" => "bbcworldnews.com",
  "BBC World News HD" => "bbcworldnews.com",
